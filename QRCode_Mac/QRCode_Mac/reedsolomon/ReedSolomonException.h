...
public:
    ReedSolomonException() throw() : message(0) {}
    ReedSolomonException(const char* msg) throw() : message(copy(msg)) {}
    ReedSolomonException(ReedSolomonException const& that) throw() : std::exception(that), message(copy(that.message)) {}
